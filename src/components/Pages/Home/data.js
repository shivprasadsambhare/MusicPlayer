export const categories = {
  ...
  items: [
    ...
    {
      href: 'https://api.spotify.com/v1/browse/categories/musik_indonesia',
      icons: [
        {
          height: null,
          url: 'https://t.scdn.co/images/65827e27210548f59accc980d350502b.jpeg',
          width: null,
        },
      ],
      id: 'musik_indonesia',
    ...
    {
      href: 'https://api.spotify.com/v1/browse/categories/karaoke',
      icons: [
        {
          height: 274,
